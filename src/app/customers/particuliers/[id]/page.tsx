          ...
          <div className="space-y-6 p-6">
            ...
            <div>
              ...
              <div className="flex items-center justify-between">
                ...
                <Button
                  onClick={() => router.push(`/customers/particuliers/${userId}/edit`)}
                ...
                <CardContent className="pt-6">
                  <div className="flex flex-col items-center text-center">
                    {user.avatar_url
                      ...
                      : (
                          <div className="flex h-24 w-24 items-center justify-center rounded-full bg-gradient-to-br from-[#009ef7] to-[#0077b6] text-white shadow-lg">
                    ...
                    <div className="mt-6 w-full space-y-3">
                      ...
                      {user.user_profile.mobile && (
                        <div className="flex items-center gap-3 rounded-lg bg-gray-50 p-3 text-sm">
                          <Phone className="h-4 w-4 flex-shrink-0 text-gray-400" />
                          <span className="text-gray-900">{user.user_profile.mobile}</span>
                        </div>
                      )}
                    </div>
                  </div>
