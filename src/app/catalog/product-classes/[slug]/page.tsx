...
import { ProductClassDetailsCard } from '@/components/catalogue/product-classes';
...
type ProductClassDetailPageProps = {
  params: Promise<{ slug: string }>;
};

export default function ProductClassDetailPage({ params }: ProductClassDetailPageProps) {
          ...
          <div className="space-y-6 p-6">
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h1 className="text-2xl font-bold text-gray-900">{productClass.name}</h1>
                  <p className="text-sm text-gray-500">Détails du type de produit</p>
                </div>
              </div>
            </div>
            ...
            <div className="rounded-lg border border-gray-200 bg-white shadow-sm">
              <ProductClassDetailsCard productClass={productClass} />
            </div>
          </div>
        </main>
      </MainContent>
